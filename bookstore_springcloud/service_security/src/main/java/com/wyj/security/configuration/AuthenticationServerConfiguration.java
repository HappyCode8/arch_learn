...
import com.wyj.security.provider.PreAuthenticatedAuthenticationProvider;
import com.wyj.security.provider.UsernamePasswordAuthenticationProvider;
...
public class AuthenticationServerConfiguration extends WebSecurityConfiguration {
    ...
    @Autowired
    private AuthenticAccountService authenticAccountDetailsService;
